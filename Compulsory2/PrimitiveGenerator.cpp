...
Mesh3D PrimitiveGenerator::createBox(float width, float height, float depth, const glm::vec3& color) {
    Mesh3D mesh;
    ...
    // Define indices for the 12 triangles (two per face)
    std::vector<unsigned int> indices = {
        // Front face
        0, 1, 2, 2, 3, 0,
        // Right face
